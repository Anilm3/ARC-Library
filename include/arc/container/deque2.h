 ...
 */
void arc_deque2_destroy(arc_deque2_t deque);
/**
 ...
 */
void * arc_deque2_at(arc_deque2_t deque, unsigned long idx);
/**
 ...
 */
int arc_deque2_push_front(arc_deque2_t deque, void * data);
/**
 * @brief Removes the first element from the deque
 *
 * @param[in] deque Deque to perform the operation on
 */
void arc_deque2_pop_front(arc_deque2_t deque);
/**
 * @brief Adds a new element to the front of the deque
 *
 * @param[in] deque Deque to perform the operation on
 ...
 * @retval ARC_SUCCESS If the element was added successfully
 */
int arc_deque2_push_back(arc_deque2_t deque, void * data);
/**
 * @brief Removes the first element from the deque
 *
 * @param[in] deque Deque to perform the operation on
 */
void arc_deque2_pop_back(arc_deque2_t deque);
/**
 ...
 * @return Data pointer of the first element
 */
void * arc_deque2_front(arc_deque2_t deque);
/**
 ...
 */
void * arc_deque2_back(arc_deque2_t deque);
/**
 ...
 */
int arc_deque2_empty(arc_deque2_t deque);
/**
 ...
 */
unsigned long arc_deque2_size(arc_deque2_t deque);
/**
 * @brief Clears the contents of the deque
 *
 * @param[in] deque Deque to perform the operation on
 */
void arc_deque2_clear(arc_deque2_t deque);
/**
 ...
 */
void arc_deque2_before_begin(arc_iterator_t it);
/**
 * @brief Sets an iterator to the initial element of the deque
 *
 * @param[in] it Iterator
 */
void arc_deque2_begin(arc_iterator_t it);
/**
 ...
 */
int arc_deque2_position(arc_iterator_t it, unsigned long idx);
/**
 * @brief Sets an iterator to the last element of the deque
 *
 * @param[in] it Iterator
 */
void arc_deque2_end(arc_iterator_t it);
/**
 ...
 * @param[in] it Iterator
 */
void arc_deque2_after_end(arc_iterator_t it);
/**
 ...
 * @retval ARC_SUCCESS If the element was added successfully
 */
int arc_deque2_insert_before(arc_iterator_t it, void * data);
/**
 ...
 * @retval ARC_SUCCESS If the element was added successfully
 */
int arc_deque2_insert_after(arc_iterator_t it, void * data);
/**
 * @brief Removes the iterator position from the deque
 *
 * @param[in] it Iterator
 */
void arc_deque2_erase(arc_iterator_t it);
/**
 ...
 */
void * arc_deque2_data(arc_iterator_t it);
/**
 ...
 */
int arc_deque2_next(arc_iterator_t it);
/**
 ...
 * @retval 1 If the current element is in the deque
 */
int arc_deque2_previous(arc_iterator_t it);
