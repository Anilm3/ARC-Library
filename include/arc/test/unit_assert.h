...
#define ARC_ASSERT_FALSE(exp) \
    ARC_ASSERT_GEN1(arc_unit_false, \
                    int, exp, \
                    #exp " == %d", 0, \
                    #exp " == %d", 1) 
/**
...
#define ARC_ASSERT_POINTER_NULL(exp) \
    ARC_ASSERT_GEN1(arc_unit_pointer_null, \
                    void *, exp, \
                    #exp " == %s", "NULL", \
                    #exp " == %p", _0) 
/**
...
#define ARC_ASSERT_POINTER_NOT_NULL(exp) \
    ARC_ASSERT_GEN1(arc_unit_pointer_not_null, \
                    void *, exp, \
                    #exp " != %s", "NULL", \
                    #exp " == %s", "NULL") 
/**
...
#define ARC_ASSERT_POINTER_EQ(left, right) \
    ARC_ASSERT_GEN2(arc_unit_pointer_eq, \
                    void *, left, \
                    void *, right, \
                    #left " == %p", _1, \
                    #left " == %p", _0)
...
#define ARC_ASSERT_INT_EQ(left, right) \
    ARC_ASSERT_GEN2(arc_unit_int_eq, \
                    int, left, \
                    int, right, \
                    #left " == %d", _1, \
                    #left " == %d", _0)
...
#define ARC_ASSERT_ULONG_EQ(left, right) \
    ARC_ASSERT_GEN2(arc_unit_ulong_eq, \
                    unsigned long, left, \
                    unsigned long, right, \
                    #left " == %lu", _1, \
                    #left " == %lu", _0)
...
#define ARC_ASSERT_FLOAT_EQ(left, right, delta) \
    ARC_ASSERT_GEN3(arc_unit_float_eq, \
                    float, left, \
                    float, right, \
                    double, delta, \
                    #left " +/- " #delta " ~= %f", _1, \
...
#define ARC_ASSERT_DOUBLE_EQ(left, right, delta) \
    ARC_ASSERT_GEN3(arc_unit_double_eq, \
                    double, left, \
                    double, right, \
                    double, delta, \
                    #left " +/- " #delta " ~= %f", _1, \
...
#define ARC_ASSERT_INT_NE(left, right) \
    ARC_ASSERT_GEN2(arc_unit_int_ne, \
                    int, left, \
                    int, right, \
                    #left " != %d", _1, \
                    #left " == %d", _0)
...
#define ARC_ASSERT_ULONG_NE(left, right) \
    ARC_ASSERT_GEN2(arc_unit_ulong_ne, \
                    unsigned long, left, \
                    unsigned long, right, \
                    #left " != %lu", _1, \
                    #left " == %lu", _0)
...
#define ARC_ASSERT_FLOAT_NE(left, right, delta) \
    ARC_ASSERT_GEN3(arc_unit_float_ne, \
                    float, left, \
                    float, right, \
                    double, delta, \
                    #left " +/- " #delta " != %f", _1, \
...
#define ARC_ASSERT_DOUBLE_NE(left, right, delta) \
    ARC_ASSERT_GEN3(arc_unit_double_ne, \
                    double, left, \
                    double, right, \
                    double, delta, \
                    #left " +/- " #delta " != %f", _1, \
...
#define ARC_ASSERT_INT_LT(left, right) \
    ARC_ASSERT_GEN2(arc_unit_int_lt, \
                    int, left, \
                    int, right, \
                    #left " < %d", _1, \
                    #left " == %d", _0)
...
#define ARC_ASSERT_ULONG_LT(left, right) \
    ARC_ASSERT_GEN2(arc_unit_ulong_lt, \
                    unsigned long, left, \
                    unsigned long, right, \
                    #left " < %lu", _1, \
                    #left " == %lu", _0)
...
#define ARC_ASSERT_FLOAT_LT(left, right, delta) \
    ARC_ASSERT_GEN3(arc_unit_float_lt, \
                    float, left, \
                    float, right, \
                    double, delta, \
                    #left " +/- " #delta " < %f", _1, \
...
#define ARC_ASSERT_DOUBLE_LT(left, right, delta) \
    ARC_ASSERT_GEN3(arc_unit_double_lt, \
                    double, left, \
                    double, right, \
                    double, delta, \
                    #left " +/- " #delta " < %f", _1, \
...
#define ARC_ASSERT_INT_LE(left, right) \
    ARC_ASSERT_GEN2(arc_unit_int_le, \
                    int, left, \
                    int, right, \
                    #left " <= %d", _1, \
                    #left " == %d", _0)
...
#define ARC_ASSERT_ULONG_LE(left, right) \
    ARC_ASSERT_GEN2(arc_unit_ulong_le, \
                    unsigned long, left, \
                    unsigned long, right, \
                    #left " <= %lu", _1, \
                    #left " == %lu", _0)
...
#define ARC_ASSERT_FLOAT_LE(left, right, delta) \
    ARC_ASSERT_GEN3(arc_unit_float_le, \
                    float, left, \
                    float, right, \
                    double, delta, \
                    #left " +/- " #delta " <= %f", _1, \
...
#define ARC_ASSERT_DOUBLE_LE(left, right, delta) \
    ARC_ASSERT_GEN3(arc_unit_double_le, \
                    double, left, \
                    double, right, \
                    double, delta, \
                    #left " +/- " #delta " <= %f", _1, \
...
#define ARC_ASSERT_INT_GT(left, right) \
    ARC_ASSERT_GEN2(arc_unit_int_gt, \
                    int, left, \
                    int, right, \
                    #left " > %d", _1, \
                    #left " == %d", _0)
...
#define ARC_ASSERT_ULONG_GT(left, right) \
    ARC_ASSERT_GEN2(arc_unit_ulong_gt, \
                    unsigned long, left, \
                    unsigned long, right, \
                    #left " > %lu", _1, \
                    #left " == %lu", _0)
...
#define ARC_ASSERT_FLOAT_GT(left, right, delta) \
    ARC_ASSERT_GEN3(arc_unit_float_gt, \
                    float, left, \
                    float, right, \
                    double, delta, \
                    #left " +/- " #delta " > %f", _1, \
...
#define ARC_ASSERT_DOUBLE_GT(left, right, delta) \
    ARC_ASSERT_GEN3(arc_unit_double_gt, \
                    double, left, \
                    double, right, \
                    double, delta, \
                    #left " +/- " #delta " > %f", _1, \
...
#define ARC_ASSERT_INT_GE(left, right) \
    ARC_ASSERT_GEN2(arc_unit_int_ge, \
                    int, left, \
                    int, right, \
                    #left " >= %d", _1, \
                    #left " == %d", _0)
...
#define ARC_ASSERT_ULONG_GE(left, right) \
    ARC_ASSERT_GEN2(arc_unit_ulong_ge, \
                    unsigned long, left, \
                    unsigned long, right, \
                    #left " >= %lu", _1, \
                    #left " == %lu", _0)
...
#define ARC_ASSERT_FLOAT_GE(left, right, delta) \
    ARC_ASSERT_GEN3(arc_unit_float_ge, \
                    float, left, \
                    float, right, \
                    double, delta, \
                    #left " +/- " #delta " >= %f", _1, \
...
#define ARC_ASSERT_DOUBLE_GE(left, right, delta) \
    ARC_ASSERT_GEN3(arc_unit_double_ge, \
                    double, left, \
                    double, right, \
                    double, delta, \
                    #left " +/- " #delta " >= %f", _1, \
...
#define ARC_ASSERT_STRING_EQ(left, right) \
    ARC_ASSERT_GEN2(arc_unit_string_eq, \
                    const char *, left, \
                    const char *, right, \
                    #left " == %s", _1, \
                    #left " == %s", _0)
...
#define ARC_ASSERT_STRING_NE(left, right) \
    ARC_ASSERT_GEN2(arc_unit_string_ne, \
                    const char *, left, \
                    const char *, right, \
                    #left " != %s", _1, \
                    #left " == %s", _0)
...
#define ARC_ASSERT_BIT_SET(num, bit) \
    ARC_ASSERT_GEN2(arc_unit_bit_set, \
                    unsigned long, num, \
                    int, bit, \
                    #num "(" #bit ") == %d", 1, \
                    #num "(" #bit ") == %d", 0)
...
#define ARC_ASSERT_BIT_NOT_SET(num, bit) \
    ARC_ASSERT_GEN2(arc_unit_bit_not_set, \
                    unsigned long, num, \
                    int, bit, \
                    #num "(" #bit ") == %d", 0, \
                    #num "(" #bit ") == %d", 1)
...
#define ARC_ASSERT_STRING_CONTAINS(str, c) \
    ARC_ASSERT_GEN2(arc_unit_string_contains, \
                    const char *, str, \
                    char, c, \
                    #str " contain %c", _1, \
                    #str " !contain %c", _1)
...
#define ARC_ASSERT_STRING_NOT_CONTAIN(str, c) \
    ARC_ASSERT_GEN2(arc_unit_string_not_contain, \
                    const char *, str, \
                    char, c, \
                    #str " !contain %c", _1, \
                    #str " contain %c", _1)
...
#define ARC_ASSERT_STRING_STARTS(str, c) \
    ARC_ASSERT_GEN2(arc_unit_string_starts, \
                    const char *, str, \
                    char, c, \
                    #str"[0] == %c", _1, \
                    #str"[0] == %c", (char)((str)[0])) 
...
#define ARC_ASSERT_STRING_ENDS(str, c) \
    ARC_ASSERT_GEN2(arc_unit_string_ends, \
                    const char *, str, \
                    char, c, \
                    #str"[last] == %c", _1, \
