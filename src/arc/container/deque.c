...
{
    unsigned long block_num = deque->start_idx / BLOCK_SIZE;
    unsigned long block_idx = deque->start_idx % BLOCK_SIZE;
...
{
    unsigned long block_num = deque->end_idx / BLOCK_SIZE;
    unsigned long block_idx = deque->end_idx % BLOCK_SIZE;
